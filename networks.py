...
class UnetSkipConnectionBlock(nn.Module):
    ...
    def __init__(self, outer_nc, inner_nc, input_nc=None, submodule=None, outermost=False, innermost=False, norm_layer=nn.BatchNorm2d, use_dropout=True, output_function='sigmoid',out_class=1):
        ...
        if outermost:
            ...
            upconv = nn.ConvTranspose2d(inner_nc*2, out_class, kernel_size=4, stride=2, padding=1)
            down = [downconv]
            if output_function == 'tanh':
...
#     def __init__(self, generated_mask):
#         super(LinearNet, self).__init__()
#         self.generated_mask=generated_mask
#     def forward(self): 
#         return self.generated_mask.argmax(dim=1)
